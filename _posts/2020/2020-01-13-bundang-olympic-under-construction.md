...
{% include i-g.html id="16pdzsRrHkNUcuIxbJ3T6aIFzCWha2F3a" alt="분당올림픽스포츠센터의 해피포인트카드입니다. 신용카드와 같은 크기이고 왼쪽이 앞면, 오른쪽이 뒷면입니다. 일일입장을 이용할 때마다 1번씩 도장을 찍어주는데요. 10번이 적립되면 1번을 무료이용할 수 있습니다." title="분당올림픽스포츠센터 해피포인트카드" %}
