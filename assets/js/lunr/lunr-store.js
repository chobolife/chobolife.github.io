var store = [{
        ...
        "teaser":null},{
        "title": "수영 고정관념 1편: 수영은 관절에 무조건 좋을까?",
        "excerpt":"오늘의 주제는 이것입니다. 정말 수영은 관절에 무조건 좋을까? ‘수영 고정관념’을 시작하며… 안녕하세요. 초보라이프입니다. 수영을 아주 잘 하지는 않지만 그래도 열심히, 꾸준히 수영을 하고 있습니다. 수영을 하면서 몸으로 느끼고 머리로 생각했던 것들을 말씀드리는 데에 어떤 방법이 좋을까 고민해 보았는데요. 수영에 대한 일반적인 인식을 중심으로 꼭 그것이 맞다, 틀리다는 것을 넘어서 제...","categories": [],
        "tags": ["일상","수영","수영초보","팁","무릎","허리","관절"],
        "url": "https://chobolife.github.io/blog/2019/09/27/swim-myth-1/",
        "teaser":null},{
        "title": "수영장 정보: 분당올림픽스포츠센터",
        "excerpt":"안녕하세요. 오늘은 분당올림픽스포츠센터의 브로셔를 공유하고 정보를 알려드리려고 합니다. 각 프로그램의 시간, 요일, 수강료, 수강대상 등의 정보가 있습니다. 브로셔 전체의 pdf 파일은 이 포스트 제일 하단에 있습니다. 분당올림픽스포츠센터 사진입니다. 사진으로 알 수 있듯이 규모가 꽤 큽니다. 분당올림픽스포츠센터에서는 굉장히 많은 종목들의 강습이 이루어지고 있는데요. 저는 수영만 이용해 보았지만 수영과 아쿠아로빅, 헬스를 비롯해서...","categories": [],
